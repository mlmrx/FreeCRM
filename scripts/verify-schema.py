...
REQUIRED_INDEXES = {
    ...
    "idx_audit_events_workspace_created_id",
    "uq_agent_policy_operation",
...
REQUIRED_TRIGGERS = {
    ...
    "agent_policy_versions_immutable_update",
    "agent_policy_versions_immutable_delete",
    "agent_policy_versions_validate",
    "agent_policy_versions_invalidate_work",
    "agent_policy_run_insert",
    "agent_policy_run_authorize",
    "agent_policy_receipt_guard",
