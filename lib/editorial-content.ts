...
export const editorialArticles: readonly EditorialArticle[] = [
  ...
  {
    slug: 'crm-agents-must-name-the-version-before-writing',
    kind: 'Field guide',
    category: 'CRM for Agents',
    title: 'Before it writes, make the CRM agent name the version',
    description: 'A conditional-write contract that turns stale records and changed approvals into safe conflicts instead of silent CRM overwrites.',
    publishedAt: '2026-09-26',
    readMinutes: 7,
    takeaways: [
      'Bind every agent proposal and approval to the exact server-issued version it inspected; a record ID alone cannot show that the context is still current.',
      'Re-check authority and the version atomically at execution, then return a typed conflict with no side effect when either has changed.',
      'Treat a conflict as new relationship information that requires refresh, comparison, and a fresh decision—not permission to replay the old write.',
    ],
    sections: [
      {
        heading: 'Approval belongs to a version, not only to a record',
        paragraphs: [
      ...
      {
        heading: 'A conflict is fresh work, not permission to retry',
        paragraphs: [
      ...
      {
        heading: 'Prove the stale path before an agent receives write access',
        paragraphs: [
    ...
    sources: [
      { label: 'RFC 6585: Additional HTTP Status Codes', publisher: 'IETF RFC Editor', url: 'https://www.rfc-editor.org/rfc/rfc6585.html' },
      { label: 'AIP-134: Standard methods: Update', publisher: 'Google', url: 'https://google.aip.dev/134' },
