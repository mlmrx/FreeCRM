...
export function makeSeedWorkspace(): CRMWorkspace {
  return {
    ...
    userName: 'Maya',
    companies: [
      { id: 'co-northstar', name: 'Northstar Labs', domain: 'northstarlabs.io', industry: 'Climate software', description: 'Carbon accounting tools for mid-market operators.' },
      { id: 'co-arc', name: 'Arc Ventures', domain: 'arc.vc', industry: 'Venture capital', description: 'Seed fund investing in resilient infrastructure.' },
      { id: 'co-looma', name: 'Looma', domain: 'looma.co', industry: 'Future of work', description: 'Async collaboration for distributed creative teams.' },
      { id: 'co-patch', name: 'Patchwork', domain: 'patchwork.health', industry: 'Health technology', description: 'Care coordination for community health teams.' },
      { id: 'co-forma', name: 'Forma Studio', domain: 'forma.studio', industry: 'Design', description: 'Independent product and brand design practice.' },
      { id: 'co-tide', name: 'Tidepool AI', domain: 'tidepool.ai', industry: 'Applied AI', description: 'Evaluation infrastructure for domain-specific AI.' },
    ],
    people: [
      { id: 'p-aisha', name: 'Aisha Malik', role: 'Founder', companyId: 'co-northstar', email: 'aisha@northstarlabs.io', phone: '+1 415 555 0132', location: 'San Francisco', tags: ['Founder', 'Climate', 'Friend'], strength: 92, lastContact: daysAgo(8), cadenceDays: 30, notes: 'Met at South Park Commons. Aisha is hiring her first growth lead and just launched Northstar 2.0.', source: 'Imported note · Mar 2026', color: 'coral' },
      { id: 'p-jon', name: 'Jon Chen', role: 'Partner', companyId: 'co-arc', email: 'jon@arc.vc', location: 'Palo Alto', tags: ['Investor', 'Climate'], strength: 84, lastContact: daysAgo(18), cadenceDays: 21, notes: 'Interested in climate infrastructure. Offered to introduce Maya to Elena at Gridline.', source: 'Meeting note · Aug 2026', color: 'violet' },
      { id: 'p-sofia', name: 'Sofia Reyes', role: 'VP Growth', companyId: 'co-looma', email: 'sofia@looma.co', location: 'New York', tags: ['Operator', 'Growth'], strength: 76, lastContact: daysAgo(27), cadenceDays: 30, notes: 'Asked for the customer discovery deck. Previously worked with Maya at Brightline.', source: 'Email note · Jul 2026', color: 'mint' },
      { id: 'p-priya', name: 'Priya Nair', role: 'Chief of Staff', companyId: 'co-patch', email: 'priya@patchwork.health', location: 'Oakland', tags: ['Healthcare', 'Operator'], strength: 68, lastContact: daysAgo(53), cadenceDays: 45, notes: 'Organizing a small healthcare founders dinner in September.', source: 'Calendar note · Jun 2026', color: 'sky' },
      { id: 'p-leo', name: 'Leo Martins', role: 'Design Director', companyId: 'co-forma', email: 'leo@forma.studio', location: 'Lisbon', tags: ['Designer', 'Collaborator'], strength: 61, lastContact: daysAgo(72), cadenceDays: 60, notes: 'Collaborated on the Orbit launch. Loves editorial systems and cycling.', source: 'Imported note · May 2026', color: 'sand' },
      { id: 'p-nora', name: 'Nora Okafor', role: 'Co-founder', companyId: 'co-tide', email: 'nora@tidepool.ai', location: 'London', tags: ['Founder', 'AI'], strength: 88, lastContact: daysAgo(12), cadenceDays: 30, notes: 'Building eval infrastructure for legal teams. Looking for two US design partners.', source: 'Call note · Aug 2026', color: 'rose' },
    ],
    followUps: [
