...
const english = {
  ...
  'onboarding.enterpriseHelp': 'Higher limits; policy authoring remains preview-only',
...
const portuguese: Dictionary = {
  ...
  'onboarding.eyebrow': 'CONFIGURE SEU ESPAÇO', 'onboarding.title': 'Como você usará o FREE CRM?', 'onboarding.body': 'Escolha um ponto de partida tranquilo. Os perfis só alteram padrões; seus dados permanecem no mesmo espaço.', 'onboarding.personal': 'Pessoal / individual', 'onboarding.personalHelp': 'O essencial para uma pessoa ou profissional independente', 'onboarding.business': 'Perfil de negócios', 'onboarding.businessHelp': 'Vendas e atendimento para um único proprietário', 'onboarding.enterprise': 'Perfil empresarial', 'onboarding.enterpriseHelp': 'Limites maiores; a criação de políticas segue em prévia', 'onboarding.ready': 'Seu espaço está pronto. Você pode mudar este perfil quando quiser.',
