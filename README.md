...
[Try the demo](https://www.freecrm.dev/tour) · [Find your setup path](https://www.freecrm.dev/start) · [Contribute](CONTRIBUTING.md)
...
record. It works in a desktop or mobile browser.

Everything in the demo is synthetic. Actions affect only the demo, and reset
or reload clears your changes. Development previews and future features are
labeled. The demo is not a shared account for your own records; those belong in
...
- **Not yet released:** shared team accounts, enterprise single sign-on, live email/calendar account sync, and general external agent execution. Second brain, adaptive Today, and capability discovery are development previews, not released workspace features.
